...
//     private InputAction mainCharMovement;
...
//         mainCharMovement = new InputAction();
...
//         // mainCharMovement.Enable();
//         // mainCharMovement.per += OnMovementPerformed; 

//         // playerControls.Player.Movement.MainCharMovement.performed += OnMovementPerformed;
//     }
...
//         // mainCharMovement.Enable();
//         // mainCharMovement.performed -= OnMovementPerformed; 
...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void TryToMove(Vector2 direction)
    {
        ...
        //  Vector2 newPos = GetGridAlignedPosition(rb.position + worldDirection);
